/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=/dev/null --strict-vars=false` (hash: 8faa08e1abe0463d6bf6fa99add6805d)
// Runtime types generated with workerd@1.20260826.1 2026-08-01 nodejs_compat
interface __BaseEnv_Env {
	ENVIRONMENT: string;
	THREAD_AGENT: DurableObjectNamespace<import("./src/index").ThreadAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ThreadAgent" | "ThinkMessengerStateAgent";
	}
